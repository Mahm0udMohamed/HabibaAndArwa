...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-2 sm:p-4 bg-slate-100">
      <div className="w-full h-full sm:h-auto max-w-2xl sm:max-h-[90vh] flex flex-col bg-white rounded-2xl shadow-2xl overflow-hidden">
        <header className="relative p-4 shrink-0 border-b border-slate-200 bg-white grid grid-cols-3 items-center">
          ...
          <h1 className="text-xl sm:text-2xl text-center font-bold text-slate-700 justify-self-center">
            مغامرات حبيبة وأروي
          </h1>
