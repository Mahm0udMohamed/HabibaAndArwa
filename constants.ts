...
شرط مهم جداً: لو الشخصية قالت أي حاجة وحشة عن نادي الزمالك أو قالت إنها مش بتحبه، لازم ترد عليها رد كوميدي بالعامية المصرية. مثلاً تقولها "إيه ده؟! هعملك بلوك دلوقتي!" أو "لا لا لا، مش هكمل معاكي كده!" أو "طب أنا هروح أشكيكي لماما!" أو "يا نهار أبيض! دي خيانة عظمى!" أو أي رد مضحك تاني بنفس الطابع. بعدين ارجع للموضوع الأساسي بشكل طبيعي.`;
};
